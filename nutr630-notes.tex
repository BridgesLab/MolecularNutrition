...
% tufte-book redefines \list in a way that breaks nomencl's default output.
% Redefine the thenomenclature environment to use description inside fullwidth.
\renewcommand{\thenomenclature}{%
  \chapter*{\nomname}%
  \addcontentsline{toc}{chapter}{\nomname}%
  \nompreamble
  \begin{fullwidth}\begin{description}}
\renewcommand{\endthenomenclature}{\end{description}\end{fullwidth}\nompostamble}
