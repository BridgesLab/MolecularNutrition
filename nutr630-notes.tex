...
% tufte-book's margin-note output routine globally resets \@listdepth during
% page breaks, which causes "Lonely \item" in any \list-based environment
% (including description, itemize, enumerate).  Work around this by redefining
% thenomenclature to avoid \list entirely: instead redefine \item locally to
% produce hanging-indent paragraphs.
\makeatletter
...
\renewcommand{\endthenomenclature}{\par}
\makeatother
\printnomenclature
