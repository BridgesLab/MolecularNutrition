...
\begin{itemize}
	\item Glucocorticoids induce PDK4 transcription via FOXO\nomenclature{FOXO}{Forkhead Box O transcription factor (e.g.\ FOXO1, FOXO3)} \citep{Connaughton2010a}.
	...
	\item Hypoxia (low oxygen) induces PDK1 via HIF1$\alpha$\nomenclature{HIF1$\alpha$}{Hypoxia Inducible Factor 1$\alpha$} \citep{Kim2006}.
\end{itemize}
...
\section{Anemia and the TCA Cycle}
