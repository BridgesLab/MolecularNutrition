...
\item Describe how digested macronutrients are absorbed across the small intestine
...
\begin{enumerate}
\item From the information discussed in this chapter, what could be one example of what the sympathetic nervous system might induce during digestion? And the same consideration for the parasympathetic?
\item In general, describe how malfunctioning of the pancreas could affect digestion.
\item What was something you learned about the upper portion of the digestive tract (oral cavity, esophagus and stomach)?
\item Which accessory organs play a role in digestion within the small intestine? Explain one role of each accessory organ.
\item A patient is prescribed a proton pump inhibitor (PPI) that blocks parietal cells from secreting HCl, eliminating gastric acid. Predict at least three downstream consequences for digestion in the stomach and small intestine, explaining the mechanism behind each.
\item A patient undergoes a cholecystectomy (surgical removal of the gallbladder). Bile is still synthesized by the liver, but is now continuously dripped into the duodenum rather than released in concentrated bursts following a meal. Evaluate how fat digestion and absorption would be affected, and explain why bile salt recycling via enterohepatic circulation might be impaired.
\item A patient with untreated celiac disease has extensive villous atrophy where the villi in the jejunum are almost completely flattened. Using your knowledge of small intestine structure and macronutrient absorption mechanisms, explain why this leads to malabsorption. Which macronutrients would you expect to be most severely affected, and why?
\end{enumerate}
