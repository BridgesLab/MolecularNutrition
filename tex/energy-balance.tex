...
% tufte-latex's \newlinetospace (used in running headers via \smallcaps) is
% incompatible with the case-changing code in LaTeX kernels from 2022 onward,
% causing "Argument of \MakeTextLowercase has an extra }" at every page break.
% Titles here never contain \\, so a plain pass-through is safe.
\renewcommand{\newlinetospace}[1]{#1}
...
\pagebreak\index{Energy Balance|(}
...
While relatively rare in observational or clinical studies, $E_{excreted}$ can be measured by fecal calorimetry, which measures the amount of energy in the feces.  A recent meta-analysis shows that the average energy lost in feces is about 5-10\% of total energy intake, but this can vary  depending on the macronutrient composition of the diet\sidenote{Diets higher in nuts, fiber, and protein tend to have less caloric absorption.} and whether the individual is consuming calories in excess \citep{yoshimuraDigestibleMetabolizableEnergy2026}.  This is an adaptive mechanism such that when energy intake is in excess, the body will absorb less, and therefore excrete more calories.  This is not just true for calories in general, but for many other nutrients including some vitamins and minerals.
...
The other side of the energy balance coin is energy expenditure, or how calories are used.  While energy intake is difficult to measure, energy expenditure is even harder to measure accurately without specialized equipment.  At a molecular level, increases in energy expenditure mean that heat is generated or an inefficiency is present.  We will discuss several examples of this through the course, but Figure~\ref{fig:cori-cycle-eb} illustrates one example.  We will discuss this in more detail when we talk about gluconeogenesis, but this cycle is active during exercise where anaerobic glycolysis generates lactate\index{Metabolites!Lactate}, which is then converted back to glucose\index{Carbohydrates!Glucose} for the muscle.  Each turn through this cycle has a net loss of 4 ATP\index{Metabolites!ATP}, but nothing new is generated.  Therefore this pathway is inefficient, in that energy (in this case ATP) is used without anything new being made or stored.  If you had a lot of Cori Cycle activity, you would have increased metabolic inefficiency and therefore caused a higher energy expenditure.

\begin{marginfigure}
\includegraphics{figures/cori-cycle.png}
\caption{An inefficient metabolic pathway, the Cori Cycle.  GNG means gluconeogenesis.  Each turn through this cycle uses up 4 ATP (6 ATP used in the liver, 2 generated in the muscle).}\label{fig:cori-cycle-eb}
\end{marginfigure}


\subsection{What are the components of energy expenditure?}
Energy expenditure can be broken down into several components which add up to one's total daily energy expenditure (TDEE)\nomenclature{TDEE}{Total Daily Energy Expenditure}.  This is shown schematically in Figure~\ref{fig:tdee-components} taken from a review on the topic \citep{Tam2015}.  These subgroups include the basal metabolic rate (BMR)\nomenclature{BMR}{Basal Metabolic Rate}, diet-induced thermogenesis (DIT)\nomenclature{DIT}{Diet-Induced Thermogenesis}, non-exercise activity thermogenesis (NEAT)\nomenclature{NEAT}{Non-Exercise Activity Thermogenesis} and exercise activity thermogenesis (EAT)\nomenclature{EAT}{Exercise Activity Thermogenesis}.  
...
\newthought{Doubly labeled-water} on the other hand allows the subject to go home and live their normal life, which might be a better approximation of their natural energy expenditure rates.  This technique is based on the differential release of isotopes after a subject drinks water labeled with stable, non-radioactive isotopes ($^2H_2^{18}O$).  The hydrogen atoms are released only with water, but the oxygen atoms are released as both CO$_2$ and water.  Because of the slower equilibration process it does not provide the temporal resolution of indirect calorimetry, but rather provides an integrated measure of total CO$_2$ production over the time period.  A third experimental method relies on energy conservation and measures E$_{intake}$ and if the subjects are weight stable, E$_{intake}$ should be equal to E$_{expenditure}$. 
...
\newthought{Obesity is mostly driven by appetite.}  While it is true that people vary in their energy expenditure, most people who are obese actually have a \emph{high} total energy expenditure (in part because greater body mass requires more energy).  When you compare obesity rates and energy expenditure across cultures and economic strata, energy expenditure does not explain these differences in obesity rates \citep{mcgroskyEnergyExpenditureObesity2025}.  Instead, these differences are predicted to be due to differences in energy intake. Another line of evidence is that genetic studies of people with obesity have shown that the majority of genetic variants associated with obesity are related to appetite control, rather than energy expenditure \citep{jefferyEvidenceImplicatingEating2007}.  Finally the drugs and interventions that are most effective in reducing obesity work primarily by reducing appetite not by increasing energy expenditure.  For example GLP-1\index{Hormones!GLP-1}\nomenclature{GLP-1}{Glucagon-like Peptide 1} Receptor Agonists\sidenote{Drugs such as Ozempic or Mounjaro.} reduce appetite (particularly towards highly palatable foods) but not energy expenditure \citep{martinTirzepatideIngestiveBehavior2025}. This is not to say that energy expenditure does not play a role in obesity, but rather that it is not the primary driver of obesity.  The primary driver of obesity is appetite, and the drive to eat more than we expend.  In the next unit we will discuss how appetite is regulated, and how this can be modified by genetics, physiology and the environment.


\section{Reflection Questions}
\begin{enumerate}
\item A participant in a 6-month weight loss trial loses 10\% of their body weight through caloric restriction. Using your knowledge of homeostatic regulation of energy balance, explain why their TDEE at their new lower weight is disproportionately reduced compared to what would be predicted from their body composition alone, and predict the consequences for long-term weight maintenance if they return to their pre-diet caloric intake.
\item Two individuals consume 500 kcal meals: one consists entirely of fat, the other entirely of protein. Using Atwater's factors and your understanding of diet-induced thermogenesis, compare the net energy available from each meal and explain why the protein meal results in greater DIT. Then evaluate whether substituting dietary fat with protein is a viable strategy for creating a negative energy balance.
\item A clinical researcher argues that reducing sedentary behavior (NEAT) is a more effective long-term strategy for weight management than structured exercise (EAT). Using your knowledge of TDEE components and the adaptive metabolic responses to caloric restriction, evaluate this claim and explain why increasing EAT alone often fails to produce the expected magnitude of weight loss.
\end{enumerate}
