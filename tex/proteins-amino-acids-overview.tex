...
\newthought{Branched-chain amino acids\sidenote{Abbreviated as BCAAs} are a special subgroup of essential amino acids.}  These three amino acids, \emph{Leucine, Isoleucine} and \emph{Valine} are very important as they relate to the amino acid pool for two reasons:
\begin{enumerate}
