...
\begin{itemize}
  \item \textbf{Gastric Inhibitory Peptide (GIP)} is secreted by K cells in the proximal small intestine. It enhances insulin secretion and slows gastric emptying modestly.
  \item \textbf{Glucagon-Like Peptide-1 (GLP-1)} is secreted by L cells in the ileum and colon in response to carbohydrates and fats. It strongly delays gastric emptying and promotes satiety.
  \item \textbf{Cholecystokinin (CCK)} is released in response to lipids and proteins and also contributes to delayed gastric motility.
\end{itemize}
