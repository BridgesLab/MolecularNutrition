...
When the chyme reaches the small intestine, the pancreas releases pancreatic juice that contains pancreatic alpha amylase, which takes over carbohydrate digestion at the higher pH of the duodenum\sidenote{Salivary alpha amylase that was denatured by gastric acid does not recover its activity when the pH rises again.}. Amylose is broken down to maltriose (trisaccharide) and further more to maltose\index{Carbohydrates!Maltose}. Alpha amylase\index{Digestive Enzymes!Pancreatic Alpha Amylase} can work on the linear chain of $\alpha$-1,4 bonds of amylopectin\index{Carbohydrates!Amylopectin} but cannot hydrolyze the branching points that are $\alpha$-1,6 bonds\sidenote{We do not have enzymes that can digest $\beta$-1,4-bonds between glucoses such as those in cellulose, making it a fiber.}. The products of amylopectin digestion by alpha amylase are therefore short branched oligosaccharides known as $\alpha$-limit dextrins, which still contain the $\alpha$-1,6 branch points, along with maltose and maltotriose.  Further digestion of the branch points yields the disaccharide isomaltose.\index{Digestive Enzymes!Isomaltase}\index{Carbohydrates!Isomaltose}
...
Once the monosaccharides cross the basolateral membrane, they are small enough molecules that they are able to enter the capillary system eventually entering the hepatic portal vein leading to the liver\index{Liver}\sidenote{hepatic = liver}. Galactose and fructose\index{Carbohydrates!Galactose}\index{Carbohydrates!Fructose} will undergo metabolism in the liver and sm all intestine to be converted into glucose and its derivatives. Glucose can be stored as glycogen\index{Carbohydrates!Glycogen}, oxidized for energy, broken down for fatty acid or amino acid synthesis or reenter circulation to tissues, all dependent on the body's energy status.
...
70--100 High & White bread, instant oatmeal, white rice, popcorn, soda \\\bottomrule
\end{tabular}
\end{table}
