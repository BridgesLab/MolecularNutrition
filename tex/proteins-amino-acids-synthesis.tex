...
Glutamate is a part of several \emph{transaminase} reactions\sidenote{Transaminases require the cofactor pyridoxal phosphate\index{Vitamins!Pyridoxal Phosphate}, derived from Vitamin B\textsubscript{6}}.  These are near-equillibrium reactions where an amino group is transfered fom glutamate to another amino acid, or vice versa.  Some examples are below:
