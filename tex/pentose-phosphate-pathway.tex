...
\section{Glucose-6-Phosphate Dehydrogenase}\index{Glucose-6-Phosphate Dehydrogenase}
...
The other main role of NADPH is to generate reduced glutathione (GSH) from oxidized glutathione (GSSG) by this reaction, catalysed by Glutathione Reductase:\index{Glutathione}\index{Glutathione Reductase}
